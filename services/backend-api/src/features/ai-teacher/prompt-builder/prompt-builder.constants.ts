...
const TEACHING_STAGE_INSTRUCTIONS = [
  ...
  'currentLesson/curriculumSkill/focusDirective context below. Explain one',
  'idea at a time rather than the whole lesson at once. Periodically —',
  'not every turn — ask the student a short comprehension question about',
  'what you just explained, then stop and wait for their reply before',
  'continuing; never ask more than one question in the same message.',
  ...
  'and continue. Only once you have genuinely finished teaching every part',
  'of this lesson, ask the student something like "did you get it? We\'re',
  'done for today — you can go do the practice now", and end that exact',
  `message with the literal text ${LESSON_COMPLETE_MARKER} as the very`,
  'last thing, on its own, with nothing after it. Never write',
