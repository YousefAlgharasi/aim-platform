    ...
    <div className="flex-1 h-full min-h-0 flex flex-col bg-[#F8FAFC]">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-5 pt-5 pb-10">
        ...
        <div className="mb-5">
          ...
          <h1 className="text-slate-900 font-extrabold text-2xl tracking-tight leading-tight m-0 mt-2">
            {chapterTitle}
          </h1>
        ...
        <div className="flex flex-col gap-3">
          {LESSONS.map((les) => (
            <button
              ...
              className={`w-full bg-white ring-1 rounded-2xl p-4 flex items-center gap-4 text-left transition-all duration-200 shadow-sm border-none cursor-pointer ${
                les.current
                  ? 'ring-2 ring-[#4F46E5] bg-indigo-50/20 shadow-md'
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="font-bold text-slate-900 text-sm m-0 leading-snug truncate">
                  {les.title}
                </p>
              ...
              {/* Arrow */}
              <svg className="size-4 text-slate-400 shrink-0" viewBox="0 0 16 16" fill="none">
