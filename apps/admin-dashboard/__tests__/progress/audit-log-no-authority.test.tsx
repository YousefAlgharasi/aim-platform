...
describe('AuditLogClient — no authority', () => {
  it('displays action from backend as-is', () => {
    renderWithProviders(<AuditLogClient logs={mockLogs} total={1} page={1} totalPages={1} filterUserId="" filterAction="" />);
  ...
  it('shows empty state', () => {
    renderWithProviders(<AuditLogClient logs={[]} total={0} page={1} totalPages={0} filterUserId="" filterAction="" />);
