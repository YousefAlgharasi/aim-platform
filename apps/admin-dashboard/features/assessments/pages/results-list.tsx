...
import type { AdminAssessmentResultItem } from '../api/admin-assessment-results-api';
import {
  AdminCard,
  AdminTable,
  AdminPagination,
  ...
  const columns: AdminTableColumn<AdminAssessmentResultItem>[] = [
    {
      key: 'studentId',
      header: 'Student',
      render: (r: AdminAssessmentResultItem) => <AdminIdCell id={r.studentId} />,
    },
    {
      key: 'score',
      header: 'Score',
      width: '80px',
      render: (r: AdminAssessmentResultItem) => <span>{r.score}%</span>,
    },
    {
      key: 'passed',
      header: 'Result',
      width: '80px',
      render: (r: AdminAssessmentResultItem) => (
    ...
    },
    {
      ...
      header: 'Attempted',
      width: '120px',
      render: (r: AdminAssessmentResultItem) => <AdminDateCell iso={r.attemptedAt} />,
    },
    {
      key: 'completedAt',
      header: 'Completed',
      width: '120px',
      render: (r: AdminAssessmentResultItem) => r.completedAt ? <AdminDateCell iso={r.completedAt} /> : <span style={{ color: 'var(--text-secondary)' }}>In progress</span>,
    },
  ];
