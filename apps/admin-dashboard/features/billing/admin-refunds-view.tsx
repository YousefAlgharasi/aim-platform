...
import { AdminDateCell, AdminIdCell, AdminStatusBadge, type AdminTableColumn } from '../../components/common';
...
const BOUNDARY_RULES = [
  'Read-only — refund status is decided by backend/provider, never by this UI.',
];
