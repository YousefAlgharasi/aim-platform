...
import type { PlacementQuestionSkillLink } from '../../../core/api/admin-placement-question-skills-api';
import type { AdminSkillSummary } from '../../content/api/admin-skills-api';
