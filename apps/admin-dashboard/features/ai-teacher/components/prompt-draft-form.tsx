...
import { AdminCard, AdminFormField, AdminInput, AdminTextarea, AdminButton } from '../../../shared/components/Misc';
import type { CreatePromptTemplateDraftPayload } from '../../../core/api/admin-ai-teacher-api';
