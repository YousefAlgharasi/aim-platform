...
export function AssessmentSubmitPage({ onDone }: AssessmentSubmitPageProps) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-between p-6 py-8 text-center bg-gradient-to-b from-indigo-50/40 via-white to-slate-50/50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 text-slate-900 dark:text-slate-100 relative overflow-hidden">
      ...
      <div className="w-full flex flex-col items-center z-10 my-auto">
        ...
        {/* Title & Subtitle */}
        <h1 className="text-slate-900 dark:text-white font-extrabold text-2xl tracking-tight m-0">
          Submission Successful!
        </h1>
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-2 mb-8 max-w-[260px] leading-relaxed">
        ...
        <div className="w-full grid grid-cols-2 gap-3 mb-8">
          {/* Completed Card */}
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm ring-1 ring-slate-200/80 dark:ring-slate-700 rounded-2xl p-4 flex flex-col items-start text-left shadow-sm">
            ...
            <span className="text-slate-400 dark:text-slate-500 text-[11px] font-semibold uppercase tracking-wider">
              Completed
            </span>
            <span className="text-slate-900 dark:text-white font-extrabold text-xl mt-0.5">
              21 <span className="text-slate-400 dark:text-slate-500 font-medium text-xs">/ 25</span>
            </span>
          </div>
          ...
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm ring-1 ring-slate-200/80 dark:ring-slate-700 rounded-2xl p-4 flex flex-col items-start text-left shadow-sm">
            ...
            <span className="text-slate-900 dark:text-white font-extrabold text-xl mt-0.5">
              4 <span className="text-slate-400 dark:text-slate-500 font-medium text-xs">questions</span>
            </span>
          </div>
        </div>
        ...
        {analyzing && (
          <div className="w-full bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-indigo-500/10 border border-indigo-200/60 dark:border-indigo-800/60 rounded-2xl p-5 backdrop-blur-md flex flex-col items-center gap-3.5 shadow-sm">
            <div className="flex items-center gap-2">
              <div className="relative">
                <div className="w-7 h-7 rounded-full border-2 border-indigo-600 dark:border-indigo-400 border-t-transparent animate-spin" />
                <SparkleIcon className="size-3.5 text-indigo-600 dark:text-indigo-400 absolute inset-0 m-auto" />
              </div>
            ...
            {/* Dynamic Step Text */}
            <p className="text-slate-700 dark:text-slate-200 font-semibold text-xs m-0 animate-pulse">
              {steps[analysisStep]}
            </p>
            ...
            <p className="text-slate-400 dark:text-slate-500 text-[11px] leading-relaxed max-w-[240px] m-0">
